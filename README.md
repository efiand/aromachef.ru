...
- Для высокоинтерактивных блоков используется [petite-vue](https://github.com/vuejs/petite-vue).
- [Валидация](test/validate.spec.js) HTML-разметки, БЭМ-нейминга, XML-структуры карты сайта.
